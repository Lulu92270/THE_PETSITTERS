...
2.times do
  user = User.create!(email: Faker::Internet.unique.email, password: Faker::Alphanumeric.alpha(number: 6), name: Faker::FunnyName.unique.name, role: ["petowner", "petsitter"].sample, address: Faker::Address.unique.full_address)
